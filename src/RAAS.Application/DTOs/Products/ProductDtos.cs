...
public record ProductListDto(
    ...
    string CategoryName, string SpiceLevel, int Stock, bool IsSampleEligible = false);
...
public record ProductDetailDto(
    ...
    int Stock, string CategoryName, Guid CategoryId, bool IsSampleEligible = false);
...
public record CreateProductRequest(
    ...
    bool IsBestseller, string ImageUrl, string[]? GalleryUrls, bool IsSampleEligible = false);

public record UpdateProductRequest(
    Guid CategoryId, string Name, string Description, string Story,
    string HealthBenefits, string UsageSuggestions, string Ingredients,
    decimal Price, decimal? CompareAtPrice, int Stock, string SpiceLevel,
    bool IsBestseller, bool IsActive, string ImageUrl, string[]? GalleryUrls, bool IsSampleEligible = false);
